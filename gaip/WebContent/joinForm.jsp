...
<form name="join" onsubmit="return validate();" action="joinProcess.jsp" >

   <table width="700" height="400" border="0"  align="center" cellspacing="1">
<td  height="5" align="center" colspan="2" style="background:pink;" ><font color=white size="5em"><p class="np">회원가입정보</p></font></td>
       ...
       <tr  height="5" align="center">
           ...
           <td colspan="2" style="background:pink;"><font color=white size="5em"><p class="np">개인정보</p></font></td>
   ...
   <center>
       ...
       <input type="reset" value="다시입력" style="border-radius:5px;" />
		...
		<input type="button" value="돌아가기" style="border-radius:5px;" onclick="location.href='loginForm.jsp'  " />
   </center>
